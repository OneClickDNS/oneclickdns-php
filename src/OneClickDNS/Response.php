...
use OneClickDNS\Struct\Pagination;
use Psr\Http\Message\ResponseInterface;

/**
 * Wrapper holding the whole http response as well as the data returned by an call to an endpoint of the OneClickDNS API.
 *
 * @package OneClickDNS
 */
class Response
